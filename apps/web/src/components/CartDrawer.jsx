            ...
            >
              ...
              {cartItems.length > 0 && (
                <div className="p-6 border-t border-border bg-card space-y-4">
                  ...
                  <button className="w-full bg-gold text-primary font-bold py-4 rounded-xl shadow-lg hover:brightness-105 active:scale-[0.99] transition flex items-center justify-center gap-2 text-sm uppercase tracking-wider">
                    Proceed to WhatsApp Approval{" "}
                    <ArrowRight className="h-4 w-4" />
                  </button>

                  <div className="flex items-center justify-center gap-2 text-[0.65rem] text-muted-foreground text-center">
                    <ShieldCheck className="h-3.5 w-3.5 text-gold" /> Free
                    Insured Shipping · 2D Artwork Sent Before Production
                  </div>
                </div>
              )}
            </motion.div>
