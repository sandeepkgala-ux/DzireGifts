            ...
            <AnimatePresence>
              {mega && (
                <motion.div
                  ...
                  className="absolute left-1/2 -translate-x-1/2 top-[calc(100%+0.5rem)] w-[720px] bg-card rounded-2xl shadow-2xl border border-border p-8 grid grid-cols-3 gap-8 z-50"
                >
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-[82%] max-w-sm bg-background p-6 overflow-y-auto shadow-2xl"
            >
